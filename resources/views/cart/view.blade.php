            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                ...
                @if(count($cart->items))
                    @foreach ($cart->items as $item)
                        <div class="grid items-center gap-2 shadow-sm sm:rounded-lg border w-full" style="grid-template-columns: 1fr 9fr 1fr 1fr 1fr">
